...
for year, day, filename in files:
    ...
    tiles_directory_local = os.path.join(base_dir, 'processed_data', 'SST', 'tiles_local')
...
for year, day, filename in files:
    ...
    tiles_directory_local = os.path.join(base_dir, 'processed_data', 'SST', 'tiles_local', dict_key1)
...
for year, day, filename in files:
    ...
    json_dir = os.path.join(base_dir, 'processed_data', 'SST', 'tiles_local', dict_key1)
...
for year, day, filename in files:
    ...
    source_directory = os.path.join(base_dir, 'processed_data', 'SST', 'tiles_local', dict_key)
...
local_tiles_dir = os.path.join(base_dir, 'processed_data', 'SST', 'tiles_local')
