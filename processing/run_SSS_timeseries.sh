...
python SSS_timeseries.py >> /home/finn.wimberly/Documents/CCCFA_app_dev/Project/processing/logs/sss_timeseries.log 2>/dev/null

# Deactivate the environment (optional)
conda deactivate

echo "Script completed at $(date)" >> /home/finn.wimberly/Documents/CCCFA_app_dev/Project/processing/logs/sss_timeseries.log