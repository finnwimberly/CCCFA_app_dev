...
def get_all_ostia_monthly_data():
...
def create_ostia_sst_monthly_plots_combined(data, region=[-75, -62, 36, 45]):
    ...
    for i in range(n_months):
        ...
        sst = data.isel(time=i)['analysed_sst'] - 273.15
...
#process data
combined_data = get_all_ostia_monthly_data()
...
def get_all_smap_monthly_data():
    """Load and combine all monthly SMAP SSS files available starting from Jan 2024"""
...
# Process data
combined_sss_data = get_all_smap_monthly_data()
